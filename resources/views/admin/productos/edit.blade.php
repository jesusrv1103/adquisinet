...
<div class="kt-container  kt-container--fluid  kt-grid_item kt-grid_item--fluid">
    ...
    <div class="kt-portlet">
        ...
        <!--begin::Form-->
        <form class="kt-form kt-form--label-right" method="POST" action="{{route('admin.productos.update', $producto->id)}}">
        {{ method_field('PUT') }}    
        {{ csrf_field() }}
            <div class="kt-portlet__body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input value="{{ $producto->nombre }}" onkeyup="mayus(this);" class="form-control" type="text" required placeholder="Ejemplo: TORTILLAS DE HARINA"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input value="{{ $producto->precio }}" name="precio" class="form-control .solo_decimales" type="number" placeholder="Ejemplo: $12.50" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input value="{{ $producto->presentacion }}" class="form-control" name="presentacion" type="text" required placeholder="Ejemplo: CAJA">
                ...
                <div class="form-group row">
                    ...
                    <div class=" col-lg-10">
                        <select required class="form-control kt-select2" id="kt_select2_1" name="partida_id">
                            ...
                            <option value="{{$producto->partida->id}}">
                                {{$producto->partida->nombre}}
                            </option>@foreach ($partidas as $partida)
                ...
                <div class="form-group row">
                    ...
                    <div class=" col-lg-10">
                        <select required class="form-control kt-select2" id="kt_select2_1" name="unidad_id">
                            <option value="{{$producto->unidad->id}}">
                ...
                <div class="form-group row">
                    ...
                    <div class=" col-lg-10">
                        <select required class="form-control kt-select2" id="kt_select2_1" name="giro_id">
                            <option value="{{$producto->giro->id}}">
                                {{$producto->giro->nombre}}
                            </option>
                    ...
                    <div class="col-10">
                        <div class="kt-radio-inline">
                            <label class="kt-radio">
                                <input type="radio" name="impuesto" value="0"> 0%
                                <span></span>
                            </label>
                            <label class="kt-radio">
                                <input type="radio" name="impuesto" value="16"
                                {{ $producto->estado == '16' ? 'checked' : '' }} > 16%
                                <span></span>
                            </label>
