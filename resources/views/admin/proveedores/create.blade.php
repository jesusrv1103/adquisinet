...
<div class="kt-container  kt-container--fluid  kt-grid_item kt-grid_item--fluid">
    ...
    <div class="kt-portlet">
        ...
        <!--begin::Form-->
        <form class="kt-form kt-form--label-right" method="POST" action="{{route('admin.proveedores.store')}}" accept-charset="utf-8" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="kt-portlet__body">
                ...
                <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="nombre" onkeyup="mayus(this);" class="form-control" required
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="razon_social" onkeyup="mayus(this);" class="form-control" required
                                    placeholder="SAM'S" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="rfc" onkeyup="mayus(this);" class="form-control" required
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="cedula" onkeyup="mayus(this);" class="form-control" required
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="domicilio" onkeyup="mayus(this);" class="form-control" required
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                            <input type="text" name="telefono" onkeyup="mayus(this);" class="form-control solo_numeros" required
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="contacto" onkeyup="mayus(this);" class="form-control" required
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="representante_legal" onkeyup="mayus(this);" class="form-control" required
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                            <input type="text" class="solo_decimales form-control" name="capital_contable" onkeyup="mayus(this);" required
                                    placeholder="192324" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="date" name="fecha_vigencia_cedula" onkeyup="mayus(this);" class="form-control" required
                                    placeholder="2020-31-12" value="2020-03-12" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="email" name="email" onkeyup="mayus(this);" class="form-control" required
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="file" id="img_cedula" name="img_cedula" accept="image/png, .jpeg, .jpg, image/gif"  onchange="readURL(this);"
                                    style="  display: none;">
